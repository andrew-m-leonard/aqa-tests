...
if [ $SPEC = "linux_ppc-64_le" ]; then
    ...
    echo "Getting https://ci.adoptium.net/job/UploadFile/138/artifact/upload/arctic-0.8.12.jar"
    wget -q https://ci.adoptium.net/job/UploadFile/138/artifact/upload/arctic-0.8.12.jar
ls -l arctic-0.8.12.jar
fi

mv arctic-0.8.12.jar ${LIB_DIR}/arctic.jar
ls -l ${LIB_DIR}
