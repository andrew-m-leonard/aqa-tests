...
if [ $SPEC = "linux_ppc-64_le" ]; then
    ...
    echo "Getting https://ci.adoptium.net/job/UploadFile/127/artifact/upload/arctic-0.8.2.jar"
    wget -q https://ci.adoptium.net/job/UploadFile/127/artifact/upload/arctic-0.8.2.jar
fi
