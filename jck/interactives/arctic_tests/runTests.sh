...
if [ $SPEC = "linux_ppc-64_le" ]; then
    ...
    echo "Getting https://ci.adoptium.net/job/UploadFile/131/artifact/upload/arctic-0.8.6.jar"
    wget -q https://ci.adoptium.net/job/UploadFile/131/artifact/upload/arctic-0.8.6.jar
ls -l arctic-0.8.6.jar
fi

mv arctic-0.8.6.jar ${LIB_DIR}/arctic.jar
ls -l ${LIB_DIR}
