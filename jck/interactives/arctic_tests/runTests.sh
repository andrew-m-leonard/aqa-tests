...
if [ $SPEC = "linux_ppc-64_le" ]; then
    ...
    echo "Getting https://ci.adoptium.net/job/UploadFile/131/artifact/upload/arctic-0.8.7.jar"
    wget -q https://ci.adoptium.net/job/UploadFile/131/artifact/upload/arctic-0.8.7.jar
